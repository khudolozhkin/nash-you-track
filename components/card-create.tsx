...
export default function CardCreate({columnId}: {columnId: string}) {
  ...
  if (isActive) {
    return (
      <div className="mt-2 mb-2 group/createCard opacity-100 transition-opacity duration-300">
    ...
    return (
      <div className="mt-2 mb-2 group/createCard opacity-0 group-hover/column:opacity-100 transition-opacity">
